  ...
  ua: {
    ...
    blocks: [
      ...
      },
      {
        id: "expansion",
        label: "Експансія",
        title: "Швидкий запуск нових країн",
  ...
  en: {
    ...
    blocks: [
      ...
      },
      {
        id: "expansion",
        label: "Expansion",
        title: "Rapid launch in new countries",
    ...
    horizons: [
      {
        ...
        period: "0-12 місяців",
        title: "AI-Copilot на кожному робочому місці",
        body: "AI-інструменти для автоматизації без залучення IT. Оператори і менеджери самі автоматизують свою рутину через AI-асистентів. Перший потік AI-champions.",
      ...
      },
      {
        ...
        metric: "Кратне скорочення часу запуску нової країни",
        highlight: null,
      },
    ],
  },
    ...
    horizons: [
      {
        ...
        period: "0-12 months",
        title: "AI-Copilot at every workstation",
        body: "AI tools for automation without involving IT. Operators and managers automate their own routine through AI assistants. First wave of AI champions.",
      ...
      },
      {
        ...
        metric: "Dramatically reduced time-to-launch for new countries",
        highlight: null,
      },
    ],
  },
...
export const slide6 = {
  ua: {
    ...
    description:
      "Оператор запитав. AI відповів. Жодного пошуку по папках, жодного дзвінка супервайзору. Правила відправлень для всіх напрямків за секунди.",
    ...
    suggestions: [
      "Що заборонено відправляти з України до Литви?",
      "Які документи потрібні для посилки з України до Литви?",
      "Як працює IOSS при відправленні до ЄС?",
  ...
  en: {
    ...
    description:
      "The operator asked. The AI answered. No folder search, no call to a supervisor. Shipping rules for all destinations in seconds.",
    ...
    suggestions: [
      "What items are prohibited from Ukraine to Lithuania?",
      "What documents are required for a parcel from Ukraine to Lithuania?",
      "How does IOSS work for EU shipments?",
